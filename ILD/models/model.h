...
// Model GUID (16 bytes)
#define IMAI_MODEL_ID {0x9c, 0x7a, 0xfd, 0x23, 0x55, 0x8d, 0x5e, 0x43, 0x96, 0xf5, 0x35, 0xa4, 0xf1, 0x21, 0xfd, 0x03}
...
#define IMAI_DATA_OUT_SYMBOLS {"unlabelled", "Chainsaw", "Standby", "Human"}
